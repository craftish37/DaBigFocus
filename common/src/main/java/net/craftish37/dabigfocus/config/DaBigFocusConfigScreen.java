...
public abstract class DaBigFocusConfigScreen extends Screen {

    private final Screen parent;
    private ConfigListWidget entries;

    protected DaBigFocusConfigScreen(Component title, Screen parent) {
        super(title);
        this.parent = parent;
    }
    ...
    protected final void init() {
        ...
        addRenderableWidget(
                Button.builder(Component.translatable("dabigfocus.option.apply"), (button) -> {
                            save();
                        })
